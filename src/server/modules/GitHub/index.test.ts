...
describe('GitHub', () => {
  describe('parseRepoUrl', () => {
    ...
    it('should parse standard GitHub URL', () => {
      const result = gh.parseRepoUrl('https://github.com/Hyk260/PureChat')
    ...
    it('should parse GitHub URL with tree/branch', () => {
      const result = gh.parseRepoUrl('https://github.com/Hyk260/PureChat/tree/develop')
      expect(result).toEqual({
        branch: 'develop',
        owner: 'Hyk260',
        repo: 'PureChat',
    ...
    it('should parse GitHub URL with tree/branch and path', () => {
      const result = gh.parseRepoUrl('https://github.com/Hyk260/PureChat/tree/feature/new-ui/src/components')
      expect(result).toEqual({
        branch: 'feature',
        owner: 'Hyk260',
    ...
    it('should capture subdirectory path from GitHub URL', () => {
      const result = gh.parseRepoUrl('https://github.com/openclaw/openclaw/tree/main/skills/skill-creator')
      expect(result).toEqual({
        branch: 'main',
        owner: 'openclaw',
    ...
    it('should capture nested subdirectory path from GitHub URL', () => {
      const result = gh.parseRepoUrl('https://github.com/Hyk260/skills/tree/develop/agents/coding/python-expert')
      expect(result).toEqual({
        branch: 'develop',
        owner: 'Hyk260',
    ...
    it('should not have path when URL has no subdirectory', () => {
      const result = gh.parseRepoUrl('https://github.com/Hyk260/PureChat/tree/main')
      expect(result).toEqual({
        branch: 'main',
        owner: 'Hyk260',
        repo: 'PureChat',
    ...
    it('should parse /blob/ URL and strip file name to get directory path', () => {
      const result = gh.parseRepoUrl('https://github.com/kepano/obsidian-skills/blob/main/skills/json-canvas/SKILL.md')
      expect(result).toEqual({
        branch: 'main',
        owner: 'kepano',
    ...
    it('should parse /blob/ URL with nested path', () => {
      const result = gh.parseRepoUrl('https://github.com/anthropics/skills/blob/main/skills/pptx/SKILL.md')
      expect(result).toEqual({
        branch: 'main',
        owner: 'anthropics',
        path: 'skills/pptx',
    ...
    it('should parse GitHub URL without protocol', () => {
      const result = gh.parseRepoUrl('github.com/Hyk260/PureChat')
      expect(result).toEqual({
        branch: 'main',
        owner: 'Hyk260',
        repo: 'PureChat',
    ...
    it('should parse GitHub URL with .git suffix', () => {
      const result = gh.parseRepoUrl('https://github.com/Hyk260/PureChat.git')
      expect(result).toEqual({
        branch: 'main',
        owner: 'Hyk260',
        repo: 'PureChat',
    ...
    it('should parse shorthand format (owner/repo)', () => {
      const result = gh.parseRepoUrl('Hyk260/PureChat')
      expect(result).toEqual({
        branch: 'main',
        owner: 'Hyk260',
        repo: 'PureChat',
    ...
    it('should use custom default branch', () => {
      const result = gh.parseRepoUrl('https://github.com/Hyk260/PureChat', 'dev')
      expect(result).toEqual({
        branch: 'dev',
        owner: 'Hyk260',
        repo: 'PureChat',
  ...
  describe('buildRepoZipUrl', () => {
    ...
    it('should build correct ZIP URL', () => {
      ...
      expect(url).toBe('https://github.com/Hyk260/PureChat/archive/refs/heads/main.zip')
    })
    ...
    it('should handle different branches', () => {
      ...
      expect(url).toBe('https://github.com/Hyk260/PureChat/archive/refs/heads/feature/new-ui.zip')
    })
  })
  ...
  describe('buildRawFileUrl', () => {
    ...
    it('should build correct raw file URL', () => {
      ...
      expect(url).toBe('https://raw.githubusercontent.com/Hyk260/PureChat/main/README.md')
    })
    ...
    it('should handle nested file paths', () => {
      ...
      expect(url).toBe('https://raw.githubusercontent.com/Hyk260/PureChat/develop/src/components/Button/index.tsx')
    })
  })
  ...
  describe('downloadRepoZip', () => {
    ...
    it('should download repository ZIP successfully', async () => {
      ...
      expect(mockFetch).toHaveBeenCalledWith('https://github.com/Hyk260/PureChat/archive/refs/heads/main.zip', {
        headers: {
          'User-Agent': 'PureChat',
        },
      })
  ...
  describe('downloadRawFile', () => {
    ...
    it('should download raw file successfully', async () => {
      ...
      expect(mockFetch).toHaveBeenCalledWith('https://raw.githubusercontent.com/Hyk260/PureChat/main/README.md', {
        headers: {
          'User-Agent': 'PureChat',
        },
      })
