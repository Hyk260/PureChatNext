...
export const COMMUNITY_MODELS: DiscoverModelItem[] = [
  {
    description:
      'GPT-4o 是 OpenAI 的多模态旗舰模型，支持文本与图像输入，在复杂推理、编程与跨领域任务上表现出色。',
    displayName: 'GPT-4o',
    id: 'gpt-4o',
    identifier: 'gpt-4o',
    providers: ['openai'],
  ...
  {
    description:
      'GPT-4o Mini 是更小、更高效的模型，在成本与速度上更具优势，同时保持接近 GPT-4o 的能力水平。',
  ...
  {
    description:
      'o1 是 OpenAI 的推理模型，在回答前进行深度思考，擅长复杂推理、数学与科学类任务。',
  ...
  {
    description:
      'o3-mini 是更快、更经济的推理模型，面向编程、数学与科学场景，在性能与成本之间取得平衡。',
