...
export default class GitHubAPI {
  ...
  // 获取 OAuth 配置
  private static getOAuthConfig(code: string, client: ClientType): RequestConfig | null {
  ...
  // 获取授权用户信息
  static async getUserInfo(code: string, client: ClientType): Promise<GitHubUser | null> {
  ...
  // 批量获取用户信息
  static async getUsersByTokens(tokens: string[]): Promise<(GitHubUser | null)[]> {
