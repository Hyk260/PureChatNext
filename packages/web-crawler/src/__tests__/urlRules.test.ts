...
describe('urlRules', () => {
  ...
  describe('specific URL patterns', () => {
    it('should match Sogou links', () => {
      const sogouRule = crawUrlRules.find((rule) => rule.urlPattern === 'https://sogou.com/link(.*)')
    ...
    it('should match YouTube links', () => {
      const youtubeRule = crawUrlRules.find((rule) => rule.urlPattern === 'https://www.youtube.com/watch(.*)')
    ...
    it('should match Reddit links', () => {
      const redditRule = crawUrlRules.find((rule) => rule.urlPattern === 'https://www.reddit.com/r/(.*)/comments/(.*)')
    ...
    it('should match arXiv PDF links', () => {
      const arxivRule = crawUrlRules.find((rule) => rule.urlPattern === 'https://arxiv.org/pdf/(.*)')
    ...
    it('should match Twitter/X links', () => {
      const twitterRule = crawUrlRules.find((rule) => rule.urlPattern === 'https://(twitter.com|x.com)/(.*)')
    ...
    it('should match sports data website with specific filter options', () => {
      const sportsRule = crawUrlRules.find((rule) => rule.urlPattern === 'https://www.qiumiwu.com/standings/(.*)')
    ...
    it('should match Mozilla Developer docs', () => {
      const mozillaRule = crawUrlRules.find((rule) => rule.urlPattern === 'https://developer.mozilla.org(.*)')
    ...
    it('should match CVPR links', () => {
      const cvprRule = crawUrlRules.find((rule) => rule.urlPattern === 'https://cvpr.thecvf.com(.*)')
    ...
    it('should match Feishu links', () => {
      const feishuRule = crawUrlRules.find((rule) => rule.urlPattern === 'https://(.*).feishu.cn/(.*)')
    ...
    it('should match Xiaohongshu (Little Red Book) links', () => {
      const xiaohongshuRule = crawUrlRules.find((rule) => rule.urlPattern === 'https://(.*).xiaohongshu.com/(.*)')
