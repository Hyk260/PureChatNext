...
import type { WechatApiClient, WechatRawMessage } from '@pure/chat-adapter/wechat'

import type { StoredWechatFilePayload, StoredWechatImagePayload } from './content'
export {
...
export type { StoredWechatFilePayload, StoredWechatImagePayload } from './content'
