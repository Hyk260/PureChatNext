...
const OUT_PATH = join(__dirname, 'generated/agents.data.ts')
...
async function main() {
  ...
  const header = [
    '/**',
    ' * Draft from `pnpm agents:sync`. The next sync overwrites this file.',
    ' * Copy chosen entries into src/const/community/agents.data.ts.',
    ' */',
