      ...
      <div className='mx-auto flex min-h-screen w-full max-w-7xl flex-col gap-6 px-4 py-5 sm:px-6 lg:px-8'>
        ...
        <header className='flex flex-col justify-between gap-4 border-b border-slate-200 pb-5 lg:flex-row lg:items-end'>
          <div>
            ...
            <h1 className='text-3xl font-semibold tracking-normal text-slate-950 sm:text-4xl'>FileS3 功能测试台</h1>
          ...
          <section className='flex flex-col gap-4'>
            <div className='rounded-lg border border-slate-200 bg-white p-4 shadow-sm'>
              <div className='flex items-start gap-3 rounded-lg border border-violet-200 bg-violet-50 p-3 text-violet-900'>
                ...
                <div>
                  <div className='text-sm font-semibold'>{actionOptions.find((o) => o.value === action)?.label}</div>
                  ...
                  <table className='w-full text-sm'>
                    <thead className='border-b border-slate-100 bg-slate-50'>
                      <tr>
                        ...
                        <th className='hidden px-4 py-2.5 text-left text-xs font-semibold text-slate-500 sm:table-cell'>
                          大小
                        </th>
                        <th className='hidden px-4 py-2.5 text-left text-xs font-semibold text-slate-500 lg:table-cell'>
                          修改时间
                        </th>
  ...
  return (
    <div className='grid gap-3'>
      <div className='flex items-center gap-2 text-sm text-slate-600'>
        <FileIcon className='size-4' />共 {data.length} 个文件
      </div>
      {data.length === 0 ? (
          ...
          <table className='w-full text-sm'>
            <thead className='border-b border-slate-100 bg-slate-50 sticky top-0'>
              <tr>
                ...
                <th className='hidden px-3 py-2 text-left text-xs font-semibold text-slate-500 sm:table-cell'>
                  Last Modified
                </th>
              </tr>
            </thead>
