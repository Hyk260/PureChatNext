...
describe('S3', () => {
  ...
  describe('constructor', () => {
    it('should initialize S3 client with correct configuration', () => {
      ...
      new S3(testFileEnv.S3_ACCESS_KEY_ID, testFileEnv.S3_SECRET_ACCESS_KEY, testFileEnv.S3_ENDPOINT, {
...
describe('FileS3', () => {
  ...
  describe('getFileContent', () => {
    ...
    it('should throw error when response body is missing', async () => {
      ...
      await expect(s3.getFileContent('test-file.txt')).rejects.toThrow('No body in response with test-file.txt')
    })
  })
  ...
  describe('getFileByteArray', () => {
    ...
    it('should throw error when response body is missing', async () => {
      ...
      await expect(s3.getFileByteArray('test-file.bin')).rejects.toThrow('No body in response with test-file.bin')
    })
  })
