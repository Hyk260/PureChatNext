...
import type { TopicDeleteScope, TopicPageSize } from '@/features/chat/types'
...
const TopicActions = memo<Props>(({ disabled, pageSize, totalCount, unfavoritedCount, onDelete, onPageSizeChange }) => {
  ...
  const confirmDelete = useCallback(
    ...
    [onDelete, totalCount, unfavoritedCount]
  )
